...
//loading images here
   ...
   restart_Img = loadImage("Sprites/Replay.png");
...
function draw(){
  ...
  || thief.isTouching(beam3) || thief.isTouching(beam4) || thief.isTouching(beam11) || thief.isTouching(beam12)){
    beam1.velocityX = 0;
    beam1.velocityY = 0;
    beam2.velocityX = 0;
    beam2.velocityY = 0;
